class Student:
    ...
    def get_min_and_max_mark(self):
        print(f'{self.name}: Max mark({max(self.grades)}), Min mark({min(self.grades)})')
...
student1.get_min_and_max_mark()
student2.get_min_and_max_mark()
student3.get_min_and_max_mark()